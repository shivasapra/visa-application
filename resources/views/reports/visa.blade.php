...
@section('header')
	...
	<div class="content-header col-md-6 col-12 mb-1">
    	<h3 class="content-header-title"><strong>Report: Visa Submission</strong></h3>
    </div>
	  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
	    <div class="breadcrumb-wrapper col-12">
	      <ol class="breadcrumb">
	        ...
	        <li class="breadcrumb-item">Report: Visa Submission
	        </li>
	      </ol>
	    </div>
	  </div>
	                 ...
	                 <table class="table table-hover mb-0">
	                    <thead>
	                      <tr>
							...
							<th>
								Submission to Visa Official Date
							</th>
	                      </tr>
	                    	</thead>
	                    <tbody>
	                    	...
	                    	<?php $i = 1;?>
								@foreach($students as $student)
			                      <tr>
									...
									<td><strong>{{$student->submission_to_visa_date}}</strong></td>
								</tr>
								@endforeach
							@else
								<tr>
